...
const Navbar = () => {
  const navigate = useNavigate()
    ...
    const navStylez = 'text-black font-bold text-sm  px-2 py-1 hover:bg-gray-100 hover:text-gray-800 rounded-lg transition duration-300'
    ...
    const navContent = (
        ...
        <div>      
          <div className='flex bg-gray-300 w-[300px] p-1 px-3 py-1 items-center mt-2 rounded-full'>
            <input type='text' placeholder='Search for products' className='px-3 py-1 w-[95%] outline-none bg-gray-300 rounded-full'/><IoSearchOutline />
          </div>
        </div>
