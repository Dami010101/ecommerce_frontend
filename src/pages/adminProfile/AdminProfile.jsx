    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-4 mb-8">
        ...
        <div>
          ...
          <p className="mb-1">
            <strong>Sex:</strong> {admin.sex}
          </p>
          <p className="mb-1">
            <strong>Age:</strong> {admin.age}
          </p>
          <p className="mb-1">
            <strong>Marital Status:</strong> {admin.maritalStatus}
          </p>
          <p className="mb-1">
            <strong>Nationality:</strong> {admin.nationality}
          </p>
          <p className="mb-1">
            <strong>Address:</strong> {`${admin.address.street}, ${admin.address.city}, ${admin.address.state}, ${admin.address.country}, ${admin.address.postcode}`}
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl overflow-y-auto max-h-full">
            <h2 className="text-xl font-bold mb-4">
              {isEditingAdmin ? 'Edit Admin Profile' : 'Edit User'}
            </h2>
            <div className="flex items-center mb-4">
              <img
